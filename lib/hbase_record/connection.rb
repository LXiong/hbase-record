module HbaseRecord
  class Connection
    ...
    def transport
      ...
      @transport ||= ::Thrift::FramedTransport.new(::Thrift::Socket.new(current_host, port, timeout))
    end
    ...
    def open(options = {})
      ...
      @instrumenter.instrument "adapter_connecting.massive_record", options do
        ...
        begin
          ...
          raise Exception.new, "Unable to connect to HBase on #{current_host}, port #{port}"
        end
      end
    end
